    ...
    <Sidebar collapsible="icon">
      ...
      <SidebarFooter className="space-y-1 p-2">
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton onClick={signOut} className="cursor-pointer bg-destructive/20 border border-destructive p-4 py-5 text-destructive hover:bg-destructive/40">
